<?php
    ...
    // 1. 데이터 받기
    $mnuCtyNo = (int)$_GET['mnuCtyNo']; 
    $end = (int)$_GET['end']; //불러올 데이터 추가
    ...
    // 3. 쿼리문
    $sql = "SELECT * FROM cMenu WHERE mnuCtyNo=$mnuCtyNo ORDER BY mnuNo DESC LIMIT 0, $end";
    // $sql = "SELECT * FROM cMenu WHERE mnuCtyNo=$mnuCtyNo ORDER BY mnuNo DESC";
